...
function CheckOut() {
    ...
    async function handlePay(e) {
        ...
        setPaying(true);
        const { client_secret } = await fetch("https://delivery-app-mern-backend.herokuapp.com/create-payment", {
            method: "POST",
            headers: {
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Full Name" value={user.name} disabled />
                        </Form.Group>
                    </Col>
                    <Col md={6}>
                        <Form.Group className="mb-3">
